...
ggplot(is_vegfruit_table,
       aes(x = is_vegfruit, y = Percentage, fill = factor(Diabetes_012))) +
  geom_col(position = "fill") +
  facet_wrap(~is_vegfruit, strip.position = "bottom",
             labeller = as_labeller(c("0" = "Non - Veggetable consumer", "1" = "Veggetable consumer"))) +
  theme_bw() +
  labs(
